...
export function renderSite(d) {
 ...
 <details class="research-details"><summary>查看代表性论文与专利申请 <span>＋</span></summary><div class="research-list">${d.research.map(r=>`<article><p>${e(r.note)}</p><h3>${e(r.title)}</h3></article>`).join('')}</div></details><p class="small-note">成果口径截至 ${e(d.updated)}。论文不含硕士学位论文；专利申请状态不等同于授权。仅展示履历摘要，不公开原始证明与未公开技术材料。</p></section>
